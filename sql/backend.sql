...
CREATE TABLE `sys_menu`  (
  ...
  `menu_type` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '菜单类型（M目录 C菜单 F按钮）',
...
CREATE TABLE `sys_role`  (
  ...
  `role_key` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限字符串',
  `order_num` int(4) DEFAULT 0 COMMENT '显示顺序',
