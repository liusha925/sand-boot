...
public class PathUtil {
   ...
   * <p>获取文件路径.</p>
   * <pre>
   *   PathUtil.getClassPath(new PathUtil()) = "...\\com\\sand\\core\\util\\global"
   * </pre>
   *
   * @param obj 对象
   * @return obj路径
   ...
   * <p>获取文件路径.</p>
   * <pre>
   *   PathUtil.getClassPath(PathUtil.class) = "...\\com\\sand\\core\\util\\global"
   * </pre>
   *
   * @param clz class
   * @return class路径
   ...
   * <p>获取对象包的路径.</p>
   * <pre>
   *    PathUtil.getPackagePath(new PathUtil()) = "com/sand/core/util/global"
   * </pre>
   *
   * @param obj 对象
   * @return package路径
   ...
   * <p>获取类包的路径.</p>
   * <pre>
   *    PathUtil.getPackagePath(PathUtil.class) = "com/sand/core/util/global"
   * </pre>
   *
   * @param clz class
   * @return package路径
