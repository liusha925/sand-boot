...
//    errorLog(e);
//    return RetUtil.error(ResultEnum.PARAM_MISSING_ERROR);
//  }
//
//  /**
//   * 打印出错log
...
//    try {
//      httpMessageConverter.write(RetUtil.error(resultEnum), MediaType.APPLICATION_JSON, new ServletServerHttpResponse(response));
//    } catch (IOException e) {
//      log.error("系统异常", e);
//    }
//  }
