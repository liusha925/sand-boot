        ...
        return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, i = Object.prototype.hasOwnProperty, a = [].slice, b = /\.js$/, f = function (e, t) {
            ...
            return f.Extend(r, f.Observable), r.prototype.render = function () {
                ...
                this.$results.attr("id", n), t.on("results:all", function (e) {
                    ...
                    var e = l.getHighlightedResults(), t = l.$results.find("[aria-selected]"), n = t.index1(e);
                    if (!(n <= 0)) {
                        var r = n - 1;
                        0 === e.length && (r = 0);
                        var i = t.eq(r);
                    ...
                    var e = l.getHighlightedResults(), t = l.$results.find("[aria-selected]"), n = t.index1(e) + 1;
                    if (!(n >= t.length)) {
                        var r = t.eq(n);
                ...
                if (0 !== e.length) {
                    var t = this.$results.find("[aria-selected]").index1(e), n = this.$results.offset().top,
